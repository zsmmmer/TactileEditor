import parse from "svg-path-properties/src/parse";
import { PointArray, Properties, PartProperties, Point } from "svg-path-properties/src/types";
import { LinearPosition } from "svg-path-properties/src/linear";
